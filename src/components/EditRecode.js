      ...
      <Container>
        ...
        <WriteWrap>
          ...
          <div style={{padding: '16px'}}>
            <TextArea type="text" placeholder='글을 입력하세요.'  name="text" value={formData.text} onChange={handleChange}/>
          </div>
          <List>
            <ListItem>
              <Label htmlFor="name">카페 이름</Label>
              <Input type="text" placeholder='카페 이름을 입력하세요.' name="cafeName" value={formData.cafeName} onChange={handleChange}/>
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              ...
              <Input type="text" placeholder='어떤 감성의 카페였나요?' name="vibes" value={formData.vibes} onChange={handleChange}/>
            </ListItem>
            <ListItem>
              <Label htmlFor="specialMenu">특별한 메뉴</Label>
              <Input type="text" placeholder='이 곳의 시그니처 메뉴는요...' name="specialMenu" value={formData.specialMenu} onChange={handleChange}/>
            </ListItem>
          </List>
          <RatingWrap>
